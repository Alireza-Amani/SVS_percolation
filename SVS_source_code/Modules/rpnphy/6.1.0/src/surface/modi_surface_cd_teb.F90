...
!-------------------------------------- LICENCE END --------------------------------------
    MODULE MODI_SURFACE_CD_TEB
!
!
!
INTERFACE SURFACE_CD_TEB
!
!
    SUBROUTINE SURFACE_CD_TEB(PRI, PZREF, PUREF, PZ0EFF, PZ0H, &
                             PCD, PCDN)
!
!
...
!
!
END MODULE MODI_SURFACE_CD_TEB
