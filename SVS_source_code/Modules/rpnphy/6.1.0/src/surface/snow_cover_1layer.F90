...
!               ------------
!
USE MODD_CSTS_TEB,       ONLY : XTT, XCI, XRHOLI, XRHOLW, XCPD, XLSTT, XLMTT, XDAY, XCONDI
USE MODD_SNOW_PAR_TEB,   ONLY : XEMISSN, SWE_CRIT
!
USE MODE_THERMOS_TEB
!
USE MODI_SURFACE_RI_TEB
...
!
CALL SURFACE_RI_TEB(ZTS_SNOW, ZQSAT, ZEXNS, ZEXNA, PTA, PQA, &
