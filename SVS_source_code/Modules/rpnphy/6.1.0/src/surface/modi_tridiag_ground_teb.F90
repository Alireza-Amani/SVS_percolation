...
!-------------------------------------- LICENCE END --------------------------------------
!     ##########################
      MODULE MODI_TRIDIAG_GROUND_TEB
!     ##########################
!
INTERFACE TRIDIAG_GROUND_TEB
!
       SUBROUTINE TRIDIAG_GROUND_TEB(PA,PB,PC,PY,PX)
!
...
!
END SUBROUTINE TRIDIAG_GROUND_TEB
!
END INTERFACE
!
END MODULE MODI_TRIDIAG_GROUND_TEB
