...
!-------------------------------------- LICENCE END --------------------------------------
    MODULE MODI_SURFACE_RI_TEB
!
!
!
INTERFACE SURFACE_RI_TEB
!
!
    SUBROUTINE SURFACE_RI_TEB(PTG, PQS, PEXNS, PEXNA, PTA, PQA,   &
...
!
!
END MODULE MODI_SURFACE_RI_TEB
